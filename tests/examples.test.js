import { parse, PartialJSON, MalformedJSON } from "../src/index"; // Removed Allow from imports
import {
  STR,
  NUM,
  ARR,
  ...
  INFINITY,
  _INFINITY,
  OUTERMOST_OBJ, // Ensure OUTERMOST_OBJ is imported
  OUTERMOST_ARR, // Add this import
} from "../src/options";
...
test("require", () => {
  expect(require("modified-partial-json").STR).toBe(STR);
});
